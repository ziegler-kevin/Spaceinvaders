...
option1 = [Option("NEW GAME", (140, 105))]
option2 = [Option("HIGHSCORE", (135, 155))]
option3 = [Option("     EXIT", (145, 205))]
...
while True:
    ...
    for option in option1:
        if option.rect.collidepoint(pygame.mouse.get_pos()):
            ...
            Button(master, text='Spiel starten', command=master.quit).grid(row=3, column=1, sticky=W, pady=4)
